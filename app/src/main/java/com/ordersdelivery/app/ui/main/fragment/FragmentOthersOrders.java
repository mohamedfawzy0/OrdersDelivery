...
import com.ordersdelivery.databinding.FragmentOthersOrderBinding;
...
@AndroidEntryPoint
public class FragmentOthersOrders extends BaseFragment {

    private MainActivity activity;
    private FragmentOthersOrderBinding binding;
    private OrdersViewModel viewModel;
    private OrderAdapter adapter;
    private String lang_no;
    private String user_id;

    public static FragmentOthersOrders newInstance(String user_id) {
        FragmentOthersOrders fragment = new FragmentOthersOrders();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_others_order, container, false);
    ...
    private void initView() {
        ...
        viewModel.getOrders(new OrdersValueBody(new OrdersValueBody.Value(user_id, lang_no, "", "")));
